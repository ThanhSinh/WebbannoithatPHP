          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="{{route('index.store')}}" method="POST" class="tm-edit-product-form">
                  @csrf 
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                        ...
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                          ...
                          <input id="image1" name="image1" type="file" class="form-control-file" required>
                        </div>
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                          <label for="image2">Image2</label>
                          <input id="image2" name="image2" type="file" class="form-control-file" required>
                        </div>
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                          <label for="image3d">Image3d</label>
                          <input id="image3d" name="image3d" type="file" class="form-control-file" required>
                        </div>
