...
<body>
        ...
        <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        @foreach($loaisanpham_all as $category)
                            <li class="{{ $category_id == $category->MaLSP ? 'active' : '' }}">
                            <a href="{{ route('loaisanpham', $category->MaLSP) }}">
                    {{ $category->TenLSP }}
                            </a>
                            </li>
                        @endforeach
    ...
    @foreach ($sanpham as $sp) 
        @if(isset($category_id) && $sp->MaLSP == $category_id || !isset($category_id))
            <!-- Single Product Area -->
            <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                <div class="single-product-wrapper">
                    <!-- Product Image -->
                    <div class="product-img">
                        <img  src="{{ asset('user/img/product-imgs/' . $sp->image) }}" alt="">
                        <!-- Hover Thumb -->
                        <img  class="hover-img" src="{{ asset('user/img/product-imgs/' . $sp->image1) }}" alt="">
                    </div>
                    ...
                    <div class="product-description d-flex align-items-center justify-content-between">
                        ...
                        <div class="product-meta-data">
                            <div class="line"></div>
                            <p class="product-price">{{$sp->gia}} $</p>
                            <a href="{{route('editshop',$sp->MaSP)}}">
                                <h6>{{$sp->tensp}}</h6>
                            </a>
                        </div>
                        <!-- Ratings & Cart -->
