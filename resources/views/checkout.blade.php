        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                ...
                <li><a href="{{route('index')}}">Home</a></li>
                    ...
                    <li class="active"><a href="{{ route('checkoutpage') }}">Checkout</a></li>
                            ...
                            <form action="{{ route('add_to_order') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="company" value="{{ session('khachhang')->HoTen }}" placeholder="First Name" >
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="company" value="{{ session('khachhang')->diachi }}" placeholder="Last Name" >
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="company" placeholder="Company Name" value="{{ session('khachhang')->SDT }}">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="email" placeholder="Email" value="{{ session('khachhang')->GioTinh }}">
                                    </div>
                                    
                                    
                                    <div class="col-12 mb-3">
                                        <textarea name="ghichu" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="Leave a comment about your order"></textarea>
                                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <div class="cart-btn mt-100">
                                ...
                                <button class="btn amado-btn w-100" type="submit">Đặt hàng</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="index.html"><img src="/user/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
